...
from src.core.pdf_extract_text import (
    get_text_page_info,
    get_text_thumbnail,
    get_page_text_preview,
    extract_text_to_files,
)
from customtkinter import CTkImage


class ExtractTextPage(ctk.CTkFrame):
    ...
    def _build_content_area(self):
        ...
        self._preview_text.insert("0.0", "Ch\u1ecdn m\u1ed9t trang \u0111\u1ec3 xem tr\u01b0\u1edbc n\u1ed9i dung v\u0103n b\u1ea3n.")
    ...
    def _show_placeholder(self):
        ...
        ctk.CTkLabel(
            ...
            text="Ch\u01b0a c\u00f3 t\u1ec7p n\u00e0o \u0111\u01b0\u1ee3c ch\u1ecdn.\n"
                 "Nh\u1ea5n 'Th\u00eam T\u1ec7p PDF' \u0111\u1ec3 m\u1edf t\u00e0i li\u1ec7u v\u00e0 tr\u00edch xu\u1ea5t v\u0103n b\u1ea3n.",
            font=FONTS["body"],
            text_color=COLORS["text_muted"],
            justify="center",
    ...
    def _build_bottom_bar(self):
        ...
        self._combine_var = ctk.BooleanVar(value=False)
    ...
    def _load_all_pages(self):
        try:
            pages = get_text_page_info(self._pdf_path)
            self._pages = pages

            self._thumbnails.clear()
            for p in pages:
                idx = p["index"]
                img = get_text_thumbnail(self._pdf_path, idx)
                if img:
    ...
    def _draw_checkbox(self, canvas, checked):
        ...
        s = 24
        if checked:
            canvas.create_rectangle(2, 2, s - 2, s - 2, fill=COLORS["accent_orange"], outline=COLORS["accent_orange"], width=1)
    ...
    def _load_preview(self, index):
        try:
            text = get_page_text_preview(self._pdf_path, index, max_chars=2000)
    ...
    def _start_extract_selected(self):
        ...
        output_dir = filedialog.askdirectory(
            title="Ch\u1ecdn th\u01b0 m\u1ee5c l\u01b0u file v\u0103n b\u1ea3n"
        )
        if not output_dir:
            return
        ...
        self._progress_bar.set(0)
        self._status_label.configure(text="\u0110ang tr\u00edch xu\u1ea5t v\u0103n b\u1ea3n...")
    ...
    def _on_extract_success(self, output_dir, count):
        ...
        if self._combine_var.get():
            mode_text = "file v\u0103n b\u1ea3n t\u1ed5ng h\u1ee3p"
        messagebox.showinfo(
            "Th\u00e0nh c\u00f4ng",
            f"\u0110\u00e3 tr\u00edch xu\u1ea5t th\u00e0nh c\u00f4ng {count} trang!\n\n"
    ...
    def _on_extract_error(self, error_msg):
        ...
        self._progress_bar.set(0)
        self._status_label.configure(text="L\u1ed7i")
        messagebox.showerror("L\u1ed7i", f"Kh\u00f4ng th\u1ec3 tr\u00edch xu\u1ea5t v\u0103n b\u1ea3n:\n\n{error_msg}")
    ...
    def _set_controls_enabled(self, enabled):
        ...
        self._extract_btn.configure(
            state=state,
            text="\u0110ang x\u1eed l\u00fd..." if not enabled else "Tr\u00edch Xu\u1ea5t V\u0103n B\u1ea3n",
        )
